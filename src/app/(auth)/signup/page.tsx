...
const signupSchema = z.object({
  name: z
    ...
    .regex(
      /^[A-Za-z]+(?:\s[A-Za-z]+)*$/,
      'Name must contain only letters, with single spaces between words. No leading/trailing spaces.'
    ),
  phone_number: z
    .string()
...
export default function SignupPage() {
  ...
  const formatName = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const formatEmail = (event: React.ChangeEvent<HTMLInputElement>) => {
    let value = event.target.value;
    // Check for spaces and trigger validation immediately
    if (value.includes(' ')) {
      event.target.value = value; // Keep the spaces to show the error
      return;
    }
    event.target.value = value;
  };
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className={`appearance-none rounded-md relative block w-full px-3 py-2 border ${errors.name ? 'border-red-500' : dirtyFields.name && !errors.name ? 'border-green-500' : 'border-gray-300'
                      } placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 ${errors.name ? 'focus:ring-red-200' : 'focus:ring-blue-500'
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className={`appearance-none rounded-md relative block w-full px-3 py-2 border ${errors.email ? 'border-red-500' : dirtyFields.email && !errors.email ? 'border-green-500' : 'border-gray-300'
                      } placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 ${errors.email ? 'focus:ring-red-200' : 'focus:ring-blue-500'
                      } focus:border-blue-500 sm:text-sm`}
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    {...register('password')}
                    className={`appearance-none rounded-md relative block w-full px-3 py-2 pr-10 border ${errors.password ? 'border-red-500' : dirtyFields.password && !errors.password ? 'border-green-500' : 'border-gray-300'
                      } placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 ${errors.password ? 'focus:ring-red-200' : 'focus:ring-blue-500'
                      } focus:border-blue-500 sm:text-sm`}
