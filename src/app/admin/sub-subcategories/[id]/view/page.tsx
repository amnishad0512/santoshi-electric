import ViewSubSubcategoryClient from './ViewSubSubcategoryClient';
...
export default async function ViewSubSubcategoryPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  return <ViewSubSubcategoryClient id={id} />;
} 