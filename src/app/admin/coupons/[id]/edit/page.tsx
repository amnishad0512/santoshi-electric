...
// This is a client component that contains the form
...
// This is the page component that uses the client component
export default function Page({ params }: { params: { id: string } }) {
  return <EditCouponForm id={params.id} />;
}

// Generate static params for all possible coupon IDs
export async function generateStaticParams() {
  // TODO: Replace with actual API call to get all coupon IDs
  const coupons = [
    { id: '1' },
    // Add more coupon IDs as needed
  ];
